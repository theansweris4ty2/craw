...
load_images :: proc() -> ([dynamic]k2.Texture, k2.Texture, k2.Texture) {
	...
	textures := [dynamic]k2.Texture
	append(&textures, walk, walk_left, attack, attack_left, jump, jump_left)

	return textures, background, middleground
}

player_action :: proc(p: ^Player) {
