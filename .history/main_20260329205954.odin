...
main :: proc() {
	...
	pImg_walk, pImg_walk_left, attack, attack_left, jump, jump_left, background, middleground :=
		load_images()
	player := Player{pImg_walk, 0, 524, 1, 1, 0, 0, 0, true, true, "walk"}
	defer k2.shutdown()
	sceneX: f32 = 0
	sceneY: f32 = 0
	gravity: f32 = 0
